...
@Component
@Slf4j
public class ChungYePlankReturnInfoComponent {
    @Autowired
    ...
    public void chuangYePlankTwo(){
        ...
        String[] rowNames = {"index","股票代码","股票名称","流通z","交易日期","开盘涨幅","尾盘是否封住","回封买入时间","连板高度(10为反包板)","溢价"};
        PoiExcelUtil poiExcelUtil = new PoiExcelUtil("创业板回封买入信息",rowNames,datas);
        try {
            poiExcelUtil.exportExcelUseExcelTitle("创业板炸板回封买入信息");
        }catch (Exception e){
